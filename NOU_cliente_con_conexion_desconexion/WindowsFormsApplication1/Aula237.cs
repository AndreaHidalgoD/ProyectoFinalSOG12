...
namespace WindowsFormsApplication1
{
    public partial class Aula237 : Form
    {
        ...
        {
            //Recogemos los datos necesarios para que funcione el servidor
            this.Nombre = Nombre;
            this.server = server;
            this.idPartida = idPartida;

        }
        public bool SeHaResuelto()
        {
            return resuelto;
        }
        ...
        private void button4_Click(object sender, EventArgs e) //boton para la derecha, si estas en +pi no
        {
            if (Posvc_3D == false)
                ...
                else if (Posvc == true) //-pi/2
                {
                    ...
                    MessageBox.Show("Engima resuelto, anota el valor 1 en el chat. NO PODRÁS VOLVER A ENTRAR EN LA SALA HASTA DENTRO DE UN TIEMPO");
                    resuelto = true;


                    this.Hide();

                    string mensaje = "15/5/" + idPartida;
